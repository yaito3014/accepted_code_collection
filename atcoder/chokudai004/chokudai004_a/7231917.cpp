// URL: https://atcoder.jp/contests/chokudai004/submissions/7231917
// Date: Sat, 31 Aug 2019 13:37:09 +0000
...
void solve()
{
  ...
  while (chrono::duration_cast<chrono::microseconds>(chrono::system_clock::now() - start).count() / 1000 < timeLimit)
  {
    ...
    // }
    init();
    if (bestscore < cnt[0] * b[0] + cnt[1] * b[1] + cnt[2] * b[2])
    {
      bestscore = cnt[0] * b[0] + cnt[1] * b[1] + cnt[2] * b[2];
      out = ans;
    }
  }
  cerr << bestscore << endl;
